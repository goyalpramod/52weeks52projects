...
// As a bonus assignment, modify your range function to take an optional third argument that indicates the “step” value used when building the array. If no step is given, the elements should go up by increments of one, corresponding to the old behavior. The function call
...
// console.log(reverseArrayInPlace([1,2,3,4,6]))
...
//     else{
//         arr.push(list.value)
//         return listToArr(list.rest, arr)
//     }
// }

// list = arrayToList([1,2,3])
// let arr = []
// console.log(listToArr(list, arr))


// const nth = (list, count) => {
//     if (count == 0){
//         return list.value
//     }
